            ...
            <div className="fixed inset-0 bg-black bg-opacity-40">
              <div className="fixed inset-0 overflow-hidden">
                <div className="absolute">
                  <div
                    className="pointers-event-none fixed inset-y-0 right-0 flex max-w-full pl-10"
                  >
                    <Transition.Child
                      as={Fragment}
                      ...
                      leave="trasform transition ease-in-out duration-500"
                          ...
                          >
                            <div className="flex flex-col items-center">
                              ...
                              <div className="flex gap-10 my-8">
                                ...
                                >
                                  <div
                                    className="bg-neutral-100 w-10 h-10 rounded-full flex items-center justify-center"
                                  >
                                    <IoTrash size={20} />
                                  </div>
